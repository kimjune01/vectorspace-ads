    ...
    },
    {
      ...
      content: (
        <StepText>
          ...
          <p style={{ color: '#bbb', marginTop: 12 }}>
            The ads aren't irrelevant because ads are inherently bad. They're irrelevant because <em style={{ color: '#FF4444' }}>Google makes more money when they're vague</em>.
          </p>
        </StepText>
      ),
    },
    {
      ...
      content: (
        <StepText>
          ...
          <p style={{ color: '#bbb' }}>
            2024. The DOJ's most effective exhibit is a Monopoly board with every road leading to Google.
          </p>
          <p style={{ color: '#bbb', marginTop: 12 }}>
            The judge rules: <span style={{ color: '#FF4444', fontWeight: 600 }}>monopoly</span>. But the ruling changes nothing. Google has the search box. 90% of searches start there. The advertisers can't leave.
          </p>
          <p style={{ color: '#888', marginTop: 12 }}>
