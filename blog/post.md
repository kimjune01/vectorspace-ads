...
description: "OpenAI's 800M-user ad platform faces a fundamental problem: auction machinery was built for keywords, but LLM conversations live in continuous embedding space. The solution may come from computational geometry."
keywords: ["ChatGPT ad auction", "embedding-based ad targeting", "AI ad auction design", "power diagram advertising", "continuous ad auction", "LLM ad auction mechanism"]
date: 2026-02-07
---
...
![Keywords vs Embeddings](../shared/diagrams/01_keywords_vs_embeddings.png)
...
![Power Diagram](../shared/diagrams/02_power_diagram.png)
...
![Bid Change](../shared/diagrams/03_bid_change.png)
...
![Anisotropic Regions](../shared/diagrams/04_anisotropic.png)
...
![Density Overlay](../shared/diagrams/05_density_overlay.png)
...
**Budget pacing.** In keyword auctions, budget management is straightforward: you know your win rate per keyword, you can predict spend. In power diagram auctions, your spend depends on the geometry of *all* your competitors' value functions. If Nike raises their bid, Peloton's territory shifts, their impression volume changes, and their spend changes — even though Peloton did nothing. How do you give advertisers reliable budget forecasting in this setting?
...
We're working on a research paper formalizing this framework and an [interactive prototype](#) that lets you explore power diagram auctions visually. If you're thinking about this problem — whether at OpenAI, Google, or in academia — we'd love to talk.

---

*This post is part of a research project on embedding-based ad auction mechanisms. The accompanying paper, "Power Diagrams for Embedding-Based Ad Auctions: Mechanism Design in Continuous Intent Space," provides formal proofs and experimental results. The game-theoretic analysis in this post is speculative and intended to map the problem space, not to claim settled conclusions.*
